...
namespace App\Models {
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Admin>|Admin selectExpression(\Illuminate\Contracts\Database\Query\Expression|string $expression, string $as)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Admin>|Admin selectVectorDistance(\Illuminate\Contracts\Database\Query\Expression|string $column, \Illuminate\Support\Collection<int, float>|\Illuminate\Contracts\Support\Arrayable|array<int, float>|string $vector, string|null $as)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Admin>|Admin whereVectorSimilarTo(\Illuminate\Contracts\Database\Query\Expression|string $column, \Illuminate\Support\Collection<int, float>|\Illuminate\Contracts\Support\Arrayable|array<int, float>|string $vector, float $minSimilarity A value between 0.0 and 1.0, where 1.0 is identical., bool $order)
     * @method static \Illuminate\Database\Eloquent\Builder<Admin>|Admin whereVectorDistanceLessThan(\Illuminate\Contracts\Database\Query\Expression|string $column, \Illuminate\Support\Collection<int, float>|\Illuminate\Contracts\Support\Arrayable|array<int, float>|string $vector, float $maxDistance, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<Admin>|Admin orWhereVectorDistanceLessThan(\Illuminate\Contracts\Database\Query\Expression|string $column, \Illuminate\Support\Collection<int, float>|\Illuminate\Contracts\Support\Arrayable|array<int, float>|string $vector, float $maxDistance)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Admin>|Admin whereNullSafeEquals(\Illuminate\Contracts\Database\Query\Expression|string $column, mixed $value, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<Admin>|Admin orWhereNullSafeEquals(\Illuminate\Contracts\Database\Query\Expression|string $column, mixed $value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Admin>|Admin whereBetween(\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|\Illuminate\Contracts\Database\Query\Expression|string $column, string $boolean, bool $not)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Admin>|Admin orWhereBetween(\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|\Illuminate\Contracts\Database\Query\Expression|string $column)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Admin>|Admin whereNotBetween(\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|\Illuminate\Contracts\Database\Query\Expression|string $column, string $boolean)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Admin>|Admin orWhereNotBetween(\Illuminate\Database\Query\Builder|\Illuminate\Database\Eloquent\Builder<mixed>|\Illuminate\Contracts\Database\Query\Expression|string $column)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Admin>|Admin havingNotBetween(string $column, iterable $values, string $boolean)
     * @method static \Illuminate\Database\Eloquent\Builder<Admin>|Admin orHavingBetween(string $column, iterable $values)
     * @method static \Illuminate\Database\Eloquent\Builder<Admin>|Admin orHavingNotBetween(string $column, iterable $values)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Admin>|Admin orderByVectorDistance(\Illuminate\Contracts\Database\Query\Expression|string $column, \Illuminate\Support\Collection<int, float>|\Illuminate\Contracts\Support\Arrayable|array<int, float> $vector)
     * @method static \Illuminate\Database\Eloquent\Builder<Admin>|Admin inRandomOrder(string|int $seed)
     * @method static \Illuminate\Database\Eloquent\Builder<Admin>|Admin inOrderOf(\Illuminate\Contracts\Database\Query\Expression|string $column, \Illuminate\Contracts\Support\Arrayable|array $values)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Admin>|Admin timeout(int|null $seconds)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Admin>|Admin setAggregate(string $function, array<\Illuminate\Contracts\Database\Query\Expression|string> $columns)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Admin>|Admin setBindings(list<mixed> $bindings, "select"|"from"|"join"|"where"|"groupBy"|"having"|"order"|"union"|"unionOrder" $type)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Admin>|Admin tap(callable($this): mixed $callback)
